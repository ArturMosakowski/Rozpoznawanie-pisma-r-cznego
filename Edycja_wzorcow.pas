...
begin
  ...
  Form2.Image5.Top:=27;
  Form2.Image5.Picture.LoadFromFile('Grafiki/ABC/æ.bmp');
  ...
  Form2.Image8.Top:=27;
  Form2.Image8.Picture.LoadFromFile('Grafiki/ABC/ê.bmp');
  ...
  Form2.Image19.Picture.LoadFromFile('Grafiki/ABC/ñ.bmp');
  ...
  Form2.Image21.Picture.LoadFromFile('Grafiki/ABC/ó.bmp');
  ...
  Form2.Image26.Picture.LoadFromFile('Grafiki/ABC/œ.bmp');
  ...
  Form2.Image33.Picture.LoadFromFile('Grafiki/ABC/Ÿ.bmp');
...
begin
  ...
  if Form2.Image5.Left=187  then Form2.Image5.Picture.LoadFromFile('Grafiki/ABC/æ.bmp');
  if Form2.Image5.Left<>187 then Form2.Image5.Picture.LoadFromFile('Grafiki/ABC/æ_off.bmp');
  ...
  if Form2.Image8.Left=187  then Form2.Image8.Picture.LoadFromFile('Grafiki/ABC/ê.bmp');
  if Form2.Image8.Left<>187 then Form2.Image8.Picture.LoadFromFile('Grafiki/ABC/ê_off.bmp');
  ...
  if Form2.Image19.Left=187  then Form2.Image19.Picture.LoadFromFile('Grafiki/ABC/ñ.bmp');
  if Form2.Image19.Left<>187 then Form2.Image19.Picture.LoadFromFile('Grafiki/ABC/ñ_off.bmp');
  ...
  if Form2.Image21.Left=187  then Form2.Image21.Picture.LoadFromFile('Grafiki/ABC/ó.bmp');
  if Form2.Image21.Left<>187 then Form2.Image21.Picture.LoadFromFile('Grafiki/ABC/ó_off.bmp');
  ...
  if Form2.Image26.Left=187  then Form2.Image26.Picture.LoadFromFile('Grafiki/ABC/œ.bmp');
  if Form2.Image26.Left<>187 then Form2.Image26.Picture.LoadFromFile('Grafiki/ABC/œ_off.bmp');
  ...
  if Form2.Image33.Left=187  then Form2.Image33.Picture.LoadFromFile('Grafiki/ABC/Ÿ.bmp');
  if Form2.Image33.Left<>187 then Form2.Image33.Picture.LoadFromFile('Grafiki/ABC/Ÿ_off.bmp');
...
begin
  ...
  if (Ktory=4)  then AssignFile(plik, 'Wzorce/æ.txt');
  if (Ktory=5)  then AssignFile(plik, 'Wzorce/d.txt');
  if (Ktory=6)  then AssignFile(plik, 'Wzorce/e.txt');
  if (Ktory=7)  then AssignFile(plik, 'Wzorce/ê.txt');
  ...
  if (Ktory=18) then AssignFile(plik, 'Wzorce/ñ.txt');
  if (Ktory=19) then AssignFile(plik, 'Wzorce/o.txt');
  if (Ktory=20) then AssignFile(plik, 'Wzorce/ó.txt');
  ...
  if (Ktory=25) then AssignFile(plik, 'Wzorce/œ.txt');
  ...
  if (Ktory=32) then AssignFile(plik, 'Wzorce/Ÿ.txt');
...
begin
  ...
  begin
    ...
    Form2.Enabled:=False;
    x:=Application.MessageBox('Musisz podaæ wszystkie trzy wzorce'+#13+'inaczej zapisanie ich nie bêdzie mo¿liwe','B³¹d przy podawaniu wzorców', MB_OK or MB_ICONWARNING);
    if x=1 then
    begin
  ...
  begin
    ...
    y:=Application.MessageBox('Czy na pewno chcesz zapisaæ wzorce ?'+#13+'Poprzednie wzorce dla tego znaku zostan¹ usuniête.','Zapisanie wzorców', MB_YESNO or MB_ICONQUESTION);
    if y=6 then
    begin
...
begin
  ...
  AssignFile(plik, 'Wzorce/æ.txt'); Rewrite(plik); Close(plik);
  AssignFile(plik, 'Wzorce/d.txt'); Rewrite(plik); Close(plik);
  AssignFile(plik, 'Wzorce/e.txt'); Rewrite(plik); Close(plik);
  AssignFile(plik, 'Wzorce/ê.txt'); Rewrite(plik); Close(plik);
  ...
  AssignFile(plik, 'Wzorce/ñ.txt'); Rewrite(plik); Close(plik);
  AssignFile(plik, 'Wzorce/o.txt'); Rewrite(plik); Close(plik);
  AssignFile(plik, 'Wzorce/ó.txt'); Rewrite(plik); Close(plik);
  ...
  AssignFile(plik, 'Wzorce/œ.txt'); Rewrite(plik); Close(plik);
  ...
  AssignFile(plik, 'Wzorce/Ÿ.txt'); Rewrite(plik); Close(plik);
  AssignFile(plik, 'Wzorce/¿.txt'); Rewrite(plik); Close(plik);
  AssignFile(plik, 'Wzorce/@.txt'); Rewrite(plik); Close(plik);
end;
{$R *.dfm}
...
begin
  Form2.AlphaBlend:=True;
  Form2.Enabled:=False;
  x:=Application.MessageBox('Wzorce wszystkich znaków zostan¹ skasowane.'+#13+'Czy na pewno chcesz kontynuowaæ?','Kasowanie wzorców', MB_YESNO or MB_ICONQUESTION);
    if x=6 then
    begin
      KasujWzorce();
      Form2.AlphaBlend:=False;
