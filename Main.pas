...
begin
  ...
  if Ktory_znak=4 then  AssignFile(plik, 'Wzorce/æ.txt');
  if Ktory_znak=5 then  AssignFile(plik, 'Wzorce/d.txt');
  if Ktory_znak=6 then  AssignFile(plik, 'Wzorce/e.txt');
  if Ktory_znak=7 then  AssignFile(plik, 'Wzorce/ê.txt');
  ...
  if Ktory_znak=18 then  AssignFile(plik, 'Wzorce/ñ.txt');
  if Ktory_znak=19 then  AssignFile(plik, 'Wzorce/o.txt');
  if Ktory_znak=20 then  AssignFile(plik, 'Wzorce/ó.txt');
  ...
  if Ktory_znak=25 then  AssignFile(plik, 'Wzorce/œ.txt');
  ...
  if Ktory_znak=32 then  AssignFile(plik, 'Wzorce/Ÿ.txt');
...
begin
  ...
  if Ktory_znak=4 then  AssignFile(plik, 'Antywzorce/æ.txt');
  if Ktory_znak=5 then  AssignFile(plik, 'Antywzorce/d.txt');
  if Ktory_znak=6 then  AssignFile(plik, 'Antywzorce/e.txt');
  if Ktory_znak=7 then  AssignFile(plik, 'Antywzorce/ê.txt');
  ...
  if Ktory_znak=18 then  AssignFile(plik, 'Antywzorce/ñ.txt');
  if Ktory_znak=19 then  AssignFile(plik, 'Antywzorce/o.txt');
  if Ktory_znak=20 then  AssignFile(plik, 'Antywzorce/ó.txt');
  ...
  if Ktory_znak=25 then  AssignFile(plik, 'Antywzorce/œ.txt');
  ...
  if Ktory_znak=32 then  AssignFile(plik, 'Antywzorce/Ÿ.txt');
