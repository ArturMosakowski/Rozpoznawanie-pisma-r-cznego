...
var
  ...
  i, j                : Integer; //iteracje
begin
  if Form5.CheckBox1.Checked=True then Nowy1:='1';
  if Form5.CheckBox2.Checked=True then Nowy1:='2';
  if Form5.CheckBox3.Checked=True then Nowy1:='3';
  if Form5.CheckBox4.Checked=True then Nowy1:='4';
  if Form5.CheckBox5.Checked=True then Nowy1:='5';
  if Form5.CheckBox6.Checked=True then Nowy1:='6';

  if Form5.CheckBox7.Checked=True  then Nowy2:='1';
  if Form5.CheckBox8.Checked=True  then Nowy2:='2';
  if Form5.CheckBox9.Checked=True  then Nowy2:='3';
  if Form5.CheckBox10.Checked=True then Nowy2:='4';
  if Form5.CheckBox11.Checked=True then Nowy2:='5';
  if Form5.CheckBox12.Checked=True then Nowy2:='6';

  if Form5.CheckBox13.Checked=True then Nowy3:='1';
  if Form5.CheckBox14.Checked=True then Nowy3:='2';
  if Form5.CheckBox15.Checked=True then Nowy3:='3';
